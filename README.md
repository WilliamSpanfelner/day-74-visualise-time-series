![Screenshot](tesla_price_v_search.jpg)
![Screenshot](btc-news-search-v-resampled-price.jpg)
![Screenshot](ue-benefits-searches-v-ue-rate.jpg)

# Google Trends Data: Resampling and Visualising Time Series with MatPlotLib, Pandas, Python in Colab Notebooks.
...
- 🧑‍💻 Another Colab/Jupyter notebooks project exploring the stock price trends, and links betwee Google search term ratings.  Multiaxis plotting is used here with various styling along with data manipulation techniques. 
